...
class CustomViewImageContainerAdapter :
    RecyclerView.Adapter<CustomViewImageContainerAdapter.AdapterViewHolder>() {
    ...
    inner class AdapterViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        var binding: CustomviewItemPhotoContainerPreviewBinding =
            CustomviewItemPhotoContainerPreviewBinding.bind(itemView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.customview_item_photo_container_preview, parent, false)
