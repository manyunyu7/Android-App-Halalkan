...
import com.feylabs.halalkan.data.remote.reqres.product.ProductCategoryResponse.ProductCategoryResponseItem
...
import com.feylabs.halalkan.databinding.FragmentSearchProductBinding
...
class SearchProductFragment : BaseFragment() {
    ...
    override fun initObserver() {
        ...
        viewModel.productCategoryLiveData.observe(viewLifecycleOwner){
            if (it is QumparanResource.Success){
                it?.data?.let {
    ...
    override fun initAction() {
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                viewModel.searchProduct(query.toString(), getSelectedCategoryId())
                return false
            }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSearchProductBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun setupCategoryChip(data: ProductCategoryResponse) {
        ...
        mdata.forEachIndexed { index, statusOrder ->
            ...
            if (statusOrder.id.toString() == viewModel.getCurrentFilterStatus()) {
                chip.isChecked = true
            }
