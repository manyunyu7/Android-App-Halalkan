...
class TurnByTurnExperienceForDriver : BaseFragment() {
     ...
     */
    private lateinit var binding: ActivityTurnByTurnExperienceDriverBinding
            ...
            mapboxReplayer.pushEvents(
                listOf(
                    ReplayRouteMapper.mapToUpdateLocation(
                        eventTimestamp = 0.0,
                        point = Point.fromLngLat(getDriverLong(), getDriverLat())
                    )
                )
            )
        ...
        mapboxNavigation.requestRoutes(
            ...
            object : RouterCallback {
                ...
                override fun onFailure(
                    ...
                    binding.textDebug.text = text +"Your Latitude is ${getMyLat()} and long is ${getMyLong()}"
